    ...
    <div dir="rtl" className="space-y-6">
      ...
      {loading ? (
        ...
        <WorkEmptyState
          ...
          description={
            hasFilters
              ? 'السبب: لا توجد نتائج مطابقة لمعايير الفلاتر الحالية (الحالة/المساحة/البحث). جرّب تخفيف الفلاتر أو اختيار مساحة فريق مختلفة.'
              : data?.team_spaces?.length
                ? 'السبب: مساحات الفرق موجودة لكن لا توجد مشاريع مسجّلة بعد في هذه المساحة المستأجرة.'
                : 'السبب: لا توجد مساحات فرق أو مشاريع مهيّأة بعد. ابدأ بمساحة فريق أولًا ثم أضف مشروعًا تجريبيًا.'
          }
        />
      )}
