                ...
                {loading ? (
                    ...
                    <div className="flex min-h-[55vh] flex-col items-center justify-center rounded-[36px] border border-dashed border-white/15 bg-white/5 text-center text-white/60">
                        ...
                        <p className="mt-2 max-w-lg text-sm">
                            السبب: لا توجد تذاكر مطبخ لهذا الفرع والمحطة المختارة حاليًا — وهذا طبيعي قبل أول طلب يُرسَل من نقطة البيع. إن كنت أرسلت طلبًا قبل لحظات ولم يظهر، تأكد أولًا من تطابق الفرع/المحطة ثم اضغط «تحديث».
                        </p>
                        {station !== 'all' ? (
