  ...
  return (
    <div dir="rtl" className="space-y-6">
      ...
      {loading ? (
        ...
        <WorkEmptyState title="ابدأ بكتابة كلمة بحث" description="ابدأ بـ حرفين على الأقل، وسنعرض النتائج حسب النوع: مشروع/مستند/مهمة/قناة." />
      ) : data.results.length ? (
        ...
        <WorkEmptyState
          ...
          description="جرّب تغيير كلمة البحث أو استخدام جزء أقصر من الاسم داخل المشاريع/المستندات/المهام/القنوات."
        />
      )}
    </div>
  );
